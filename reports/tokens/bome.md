...
Launched via a controversial presale model where a single entity handled initial liquidity. High insider score due to the mechanics of the launch and supply concentration.
